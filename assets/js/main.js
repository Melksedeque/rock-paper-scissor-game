...
const choicesScreen = document.getElementById('choices');
...
document.querySelectorAll('button[data-choice]').forEach(button => {
	button.addEventListener('click', () => {
		...
		let iconPlayerChoice, iconCpuChoice;
		if (playerChoice == 'rock') {
			iconPlayerChoice = svgRock;
		}
		else if (playerChoice == 'paper') {
			iconPlayerChoice = svgPaper;
		}
		else {
			iconPlayerChoice = svgScissor;
		}
		if (cpuChoice == 'rock') {
			iconCpuChoice = svgRock;
		}
		else if (cpuChoice == 'paper') {
			iconCpuChoice = svgPaper;
		}
		else {
			iconCpuChoice = svgScissor;
		}

		document.getElementById('playerChoice').innerHTML = '<span id="'+playerChoice+'">'+iconPlayerChoice+'</span>';
		document.getElementById('cpuChoice').innerHTML = '<span id="'+cpuChoice+'">'+iconCpuChoice+'</span>';
		...
		choicesScreen.classList.toggle('d-none');
		resultScreen.classList.toggle('d-none');
